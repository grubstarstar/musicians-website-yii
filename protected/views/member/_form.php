...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'profilePicURL'); ?>
		<?php echo $form->textField($model,'profilePicURL',array('size'=>60,'maxlength'=>80)); ?>
		<?php echo $form->error($model,'profilePicURL'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'keepMe_hash'); ?>
		<?php echo $form->textField($model,'keepMe_hash',array('size'=>32,'maxlength'=>32)); ?>
		<?php echo $form->error($model,'keepMe_hash'); ?>
	</div>
