...
CREATE TABLE `label` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `FK_U_label_group` (`group_id`),
  CONSTRAINT `FK_label_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `band` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `FK_U_band_group` (`group_id`),
  KEY `FK_band_label` (`label_id`),
  CONSTRAINT `FK_band_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_band_label` FOREIGN KEY (`label_id`) REFERENCES `label` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `producer` (
  ...
  `label_id` smallint(5) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `FK_U_producer_group` (`group_id`),
  KEY `FK_producer_label` (`label_id`),
  CONSTRAINT `FK_producer_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_producer_label` FOREIGN KEY (`label_id`) REFERENCES `label` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promoter` (
  ...
  `group_id` int unsigned NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `FK_U_promoter_group` (`group_id`),
  CONSTRAINT `FK_promoter_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event` (
  ...
  `to` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_event_promoter` (`promoter_id`),
  CONSTRAINT `FK_event_promoter` FOREIGN KEY (`promoter_id`) REFERENCES `promoter` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `band_event` (
  ...
  `is_internal` char(1) NOT NULL DEFAULT 'Y',
  `band_name` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`band_id`,`event_id`),
  KEY `FK_b2e_event` (`event_id`),
  KEY `FK_b2e_band` (`band_id`),
  CONSTRAINT `FK_b2e_band` FOREIGN KEY (`band_id`) REFERENCES `band` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_b2e_event` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `group_genre` (
  ...
  `group_id` int unsigned NOT NULL,
  PRIMARY KEY (`genre_id`,`group_id`),
  KEY `FK_g2g_group` (`group_id`),
  KEY `FK_g2g_genre_lookup` (`genre_id`),
  CONSTRAINT `FK_g2ag_artistgroup` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_g2ag_genre_lookup` FOREIGN KEY (`genre_id`) REFERENCES `genre_lookup` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member` (
  ...
  `profile_pic_url` varchar(80) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `group_member` (
  ...
  KEY `FK_m2g_group` (`group_id`),
  KEY `FK_m2g_member` (`member_id`),
  CONSTRAINT `FK_m2g_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_m2g_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member_activation` (
  ...
  PRIMARY KEY (`regkey`,`member_id`),
  KEY `FK_member_reg_member` (`member_id`),
  CONSTRAINT `FK_member_reg_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
...
CREATE TABLE `member_instrument` (
  `member_id` int unsigned NOT NULL,
  `instrument_id` smallint(3) unsigned NOT NULL,
  `skillLevel` tinyint(3) DEFAULT NULL,
  PRIMARY KEY (`member_id`,`instrument_id`),
  KEY `FK_m2i_instrument_lookup` (`instrument_id`),
  KEY `FK_m2i_member` (`member_id`),
  CONSTRAINT `FK_m2i_instrument_lookup` FOREIGN KEY (`instrument_id`) REFERENCES `instrument_lookup` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_m2i_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `song` (
  ...
  `waveform_url` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_song_group` (`group_id`),
  CONSTRAINT `FK_song_group` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`)
